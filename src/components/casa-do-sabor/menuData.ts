...
export const categories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { slug: "biscoito-suico", name: "Biscoito Suíço", description: "1 unidade", price: "R$ 3,00", priceValue: 3 },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "afogatto-cookie-baileys", name: "Afogatto Cookie Baileys", description: "Sorvete de creme, calda de chocolate, licor Baileys, café espresso e mini cookie da Lê · 400ml", price: "R$ 28,00", priceValue: 28 },
      { slug: "aperol-spritz", name: "Aperol Spritz", description: "Vinho frizante, Aperol, laranja e gelo · 400ml", price: "R$ 28,00", priceValue: 28 },
    ],
  },
  {
    id: "mocktail",
  ...
  },
  {
    ...
    items: [
      { slug: "gelato-p", name: "Gelato P", description: "Escolha até dois sabores", price: "R$ 16,00", priceValue: 16 },
      { slug: "gelato-m", name: "Gelato M", description: "Escolha até dois sabores", price: "R$ 19,00", priceValue: 19 },
      { slug: "gelato-g", name: "Gelato G", description: "Escolha até três sabores", price: "R$ 22,00", priceValue: 22 },
      ...
      { slug: "banana-split", name: "Banana Split", description: "O clássico da nossa infância. Três bolas de gelato (escolha seu sabor preferido), acompanha banana, morango, calda de chocolate, castanhas, chantilly, cerejas e biju", price: "R$ 37,00", priceValue: 37 },
      ...
      { slug: "waffle-morango-banana-nutella", name: "Waffle Americano com morango, banana e Nutella", price: "R$ 27,00", priceValue: 27 },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "pipoca-ninho", name: "Pipoca gourmet de Ninho®", description: "1 unidade", price: "R$ 19,00", priceValue: 19 },
    ],
  },
  {
    id: "brownies",
    ...
    partner: { name: "Doçuras da Lê" },
    items: [
      { slug: "brownie-tradicional", name: "Brownie Tradicional", description: "1 unidade", price: "R$ 12,00", priceValue: 12 },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "bolo-frutas-vermelhas", name: "Frutas vermelhas", description: "1 unidade", price: "R$ 15,00", priceValue: 15 },
